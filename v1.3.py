...
class register:
    def bookRegister(self,bookName):
        e = conn.cursor()
        print(f"Do you want to take the book or mail ebook you as pdf ?")
        speak(f"Do you want to take the book or mail ebook you as pdf ?")
  ...
  <center>
      <img src="https://github.com/Aamir041/VEMM/blob/main/VEL.png?raw=true" alt="VEL" style="border-radius: 70px;">
          ...
          <p style="  background-color: #379683; padding: 5px; font-family: monospace;  font-size: large; width: 300px; border-radius: 40px ; ">
              <a href="{link}" style="text-decoration: none; color: darkblue;">Click here to download <br>{bookName.upper()}</a>
          </p>
